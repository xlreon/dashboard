...
import FeatureDrawer from '../FeatureDrawer/FeatureDrawer.jsx';
              ...
              <ExpansionPanel className={classes.itemLink + listItemClasses}>
                ...
                <ExpansionPanelDetails>
                  {/* <Typography className={whiteFontClasses}> */}
                    ...
                    <List>
                      <NavLink>
                        <Typography className={whiteFontClasses}>one</Typography>
                      </NavLink>
                      <NavLink>
                        <Typography className={whiteFontClasses}>two</Typography>
                      </NavLink>
                    </List>
                    </Drawer> */}
                    {/* <Drawer 
                    ...
                    >
                      <List>
                        <NavLink>
                          <Typography className={whiteFontClasses}>x</Typography>
                        </NavLink>
                        <NavLink>
                          <Typography className={whiteFontClasses}>y</Typography>
                        </NavLink>
                      </List>
                    </Drawer> */}
                  {/* </Typography> */}
